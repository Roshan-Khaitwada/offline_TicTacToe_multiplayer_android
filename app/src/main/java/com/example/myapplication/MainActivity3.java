...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arr = getIntent().getStringArrayExtra("playerNames");
        final String a=arr[0];
        final String b=arr[1];
        if (arr != null && arr.length >= 2) {
            textView4.setText("1."+a + " = 'O'" + "   v/s   " +"2."+ b + " = 'X'");
        }
        ...
        reversebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(one)
                {
                    textView4.setText("1."+arr[0] + " = 'O'" + "   v/s   " +"2."+ arr[1] + " = 'X'");
                }
                else
                {
                    textView4.setText("1."+arr[1] + " = 'X'" + "   v/s   " +"2."+ arr[0] + " = 'O'");
